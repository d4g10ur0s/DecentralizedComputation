...
to setup
  ...
  ask patches with [pxcor = min-pxcor]
    [ ignite ]
  ;; set tree counts
  set initial-trees count patches with [pcolor = 66 or pcolor = 53]
  set burned-trees 0
  let dromos min-pycor
  while [dromos <= 0]
  [
    ask patch 50 dromos
    [
...
to go
  ...
  ask fires
  [
    ask neighbors with [pcolor = 66 or pcolor = 53]
    [
      if (count neighbors with [pcolor = 66 or pcolor = 53] <= 8 - at_least)
      [
       ignite
       let direction random-float 9
       if direction >= 1 and direction < 2
        [;;gia na paw diagwnia panw
          let to_burn 1
          let maxIterations air_velocity_km
          while [to_burn < maxIterations]
          [
            if (patch-at 0 (1 * to_burn) != nobody)
            [
              ask patch-at 0 (1 * to_burn)
              [
                if(pcolor = 66 or pcolor = 53)[ignite]
              ]
            ]
            if (patch-at (1 * to_burn) (1 * to_burn) != nobody)
            [
              ask patch-at (1 * to_burn) (1 * to_burn)
              [
                if(pcolor = 66 or pcolor = 53)[ignite]
              ]
            ]
            if (patch-at (1 * to_burn) 0 != nobody)
            [
              ask patch-at (1 * to_burn) 0
              [
                if(pcolor = 66 or pcolor = 53)[ignite]
              ]
            ]
            set to_burn to_burn + 1
          ]
        ]
        ;;gia na paw diagwnia panw
        ...
        [;;gia na paw deksia
          ...
          while [to_burn < maxIterations]
          [
            if (patch-at (1 * to_burn) 1 != nobody)
            [
              ask patch-at (1 * to_burn) 1
              [
                if(pcolor = 66 or pcolor = 53)[ignite]
              ]
            ]
        ...
        ;;gia deksia
        if direction >= 3 and direction < 4
        [;;gia na paw na paw diagwnia katw deksia
          let to_burn 1
          let maxIterations air_velocity_km
          while [to_burn < maxIterations]
          [
        ...
        ;;gia na paw diagwnia katw deksia
        if direction >= 4 and direction < 5
        [;;gia na paw na paw katw
          let to_burn 1
          let maxIterations air_velocity_km
          while [to_burn < maxIterations]
          [
            if (patch-at 1 (- 1 * to_burn) != nobody)
            [
              ask patch-at 1 (-1 * to_burn)
              [
                if(pcolor = 66 or pcolor = 53)[ignite]
              ]
            ]
        ...
        [;;gia na paw na paw katw aristera
          let to_burn 1
          let maxIterations air_velocity_km
          while [to_burn < maxIterations]
          [
        ...
        ;;gia na paw aristera katw
        if direction >= 6 and direction < 7
        [;;gia na paw na paw aristera
          let to_burn 1
          let maxIterations air_velocity_km
          while [to_burn < maxIterations]
          [
        ...
        ;;gia na paw aristera
       if direction >= 7 and direction < 8
        [;;gia na paw na paw aristera panw
          let to_burn 1
          let maxIterations air_velocity_km
          while [to_burn < maxIterations]
          [
       ...
       ;;gia na paw aristera panw
       if direction >= 8 and direction < 9
        [;;gia na paw na paw panw
          let to_burn 1
          let maxIterations air_velocity_km
          while [to_burn < maxIterations]
          [
